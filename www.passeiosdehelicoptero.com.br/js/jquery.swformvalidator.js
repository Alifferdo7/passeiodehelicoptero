function globalCmsFormConfig(e) {
    e = 'undefined' == typeof e ? '' : e + ' ';
    var t = [
        e + ' input.not_null',
        e + ' select:visible.not_null',
        e + ' textarea:visible.not_null',
        e + ' input:visible.not_zero',
        e + ' input:visible.not_null_no_trim',
        e + ' textarea:visible.not_null_no_trim',
    ].join(', ');
    $(t).each(function () {
        ...
        $(e + ' .fone').addClass('number_mask'),
        $(e + ' .fone')
            .attr('mask', '(**) ****-*****')
            .attr('placeholder', '(xx) xxxx-xxxxx'),
        $(e + ' .cep').addClass('number_mask'),
        $(e + ' .cep')
            .attr('mask', '**.***-***')
            .attr('placeholder', 'xx.xxx-xxx'),
        $(e + ' .cpf').addClass('number_mask'),
        $(e + ' .cpf')
            .attr('mask', '***.***.***-**')
            .attr('placeholder', 'xxx.xxx.xxx-xx'),
        $(e + ' .cnpj').addClass('number_mask'),
        $(e + ' .cnpj')
            .attr('mask', '***.***.***/****-**')
            .attr('placeholder', 'xxx.xxx.xxx/xxxx-xx'),
        $(e + ' .rg').addClass('number_mask'),
        $(e + ' .rg')
            .attr('mask', '************')
            .attr('placeholder', 'xxxxxxxxx'),
        $(e + ' input[type=text].int').each(function () {
            $(this).addClass('integer').removeClass('int');
        }),
        $(e + ' .integer').addClass('number_mask'),
        $(e + ' .integer').attr('mask', '**********'),
        $(e + ' .time').addClass('number_mask'),
        $(e + ' .time')
            .attr('mask', '**:**')
            .attr('placeholder', '00:00'),
        $(e + ' .date').addClass('number_mask'),
        $(e + ' .date')
            .attr('mask', '**/**/****')
            .attr('placeholder', 'xx/xx/xxxx'),
        $(e + ' .alphanum_mask').attr('mask', '******************************'),
        $(e + ' .alpha_mask').attr('mask', '******************************'),
        $(e + ' .alpha_plus_mask').attr(
            'mask',
            '******************************'
        ),
        $(e + ' .alphanum_plus_mask').attr(
            'mask',
            '******************************'
        ),
        'undefined' != typeof $('#_TEST_').maskMoney &&
            ['percent', 'decimal_1', 'decimal_2', 'decimal_3'].forEach(
                function (t, a) {
                    var n = a ? a : 1,
        ...
        'undefined' != typeof $('#_TEST_').chosen &&
...
$(document).ready(function () {
    $('form.swformvalidator').each(function (e, t) {
        var a = $(t).attr('id')
            ? '#' + $(t).attr('id') + ' '
            : 'form[name="' + $(t).attr('name') + '"]';
        globalCmsFormConfig(a);
    });
});
var validator = {
        vTypes: [
        ...
        formValidate: function (e, t) {
            ...
            return (
                $(
                    ...
                    var e = this,
                        a = !0;
                    validator.changeStatus(e, !0),
                        validator.vTypes.forEach(function (n) {
                            $(e).hasClass(n) &&
                                a &&
                                ((a = validator.validType(e, n)),
                                a ||
                                    (validator.changeStatus(e, a),
                                    t.push({
                                        field: $(e),
                                        msg: validator.warnings[n].replace(
                                            '{0}',
                                            $(e)
                                                .parent()
                                                .children('label')
        ...
        fieldValidate: function (e) {
            ...
            return (
                validator.vTypes.forEach(function (n) {
                    $(e).hasClass(n) &&
                        t &&
                        ((t = validator.validType(e, n)),
                        (a = validator.warnings[n].replace(
                            '{0}',
                            $(e).parent().children('label').html()
                        )));
                }),
                validator.changeStatus(e, t, a),
                t
            );
        },
        validType: function (el, type) {
            ...
            return 'function' == typeof test
                ? test($(el).val(), el)
                : void console.log('test is not a function');
        },
        test: {
            ...
            cnpj: function (e) {
                ...
                for (
                    ...
                    (n += t.charAt(s - r) * i--), 2 > i && (i = 9);
                if (((o = 2 > n % 11 ? 0 : 11 - (n % 11)), o != a.charAt(0)))
                    return !1;
                for (
                    s += 1, t = l.substring(0, s), n = 0, i = s - 7, r = s;
                    r >= 1;
                    r--
                )
                    (n += t.charAt(s - r) * i--), 2 > i && (i = 9);
            ...
            cpf: function (e) {
                ...
                if (i) return !1;
                for (
                    t = e.substring(0, 9), a = e.substring(9), n = 0, r = 10;
                    r > 1;
                    r--
                )
                    n += t.charAt(10 - r) * r;
                if (((o = 2 > n % 11 ? 0 : 11 - (n % 11)), o != a.charAt(0)))
                    return !1;
                for (t = e.substring(0, 10), n = 0, r = 11; r > 1; r--)
                    n += t.charAt(11 - r) * r;
                return (
                    (o = 2 > n % 11 ? 0 : 11 - (n % 11)),
                    o != a.charAt(1) ? !1 : !0
            ...
            date: function (e) {
                ...
                var a = e.split('/'),
                    ...
                    i = new Date(n, r, o),
                    s = new Date();
                return n > s.getUTCFullYear() + 10
                    ? !1
                    : n < s.getUTCFullYear() - 120
                    ? !1
                    : i.getMonth() != r
                    ? !1
                    : i.getUTCFullYear() != n
            ...
            not_null: function (e, t) {
                return 'undefined' == typeof e
                    ? (console.log('Value is undefined.'), !1)
                    : '' != (e + '').trim();
            },
        ...
        showErrorBox: function (e, t) {
            if (
                ('form' != $(e).prop('tagName').toLowerCase() &&
                    (e = '#' + $(e).closest('form').attr('id')),
                t.length > 0)
            )
                for (var a in t) {
                    var n = $(t[a].field)
        ...
        changeStatus: function (e, t, a) {
            ...
            return (
                t
                    ? ($(e).removeClass('invalid'), n && $(n).html(''))
                    : ($(e).addClass('invalid'), n && $(n).html(a)),
                t
            );
        },
    },
    maskInput = {
        init: function () {
            $('input:visible.number_mask')
                ...
                $('input:visible.number_mask')
                    .not('.cnpj , .cpf')
                    .keyup(function (e) {
                        return maskInput.keyCodes(e.keyCode, [8, 9])
                            ? !1
                            : (maskInput.keyUpTest(this, /^\d+$/),
                              maskInput.keyCodeTest.number(e.keyCode)
                                  ? void validator.fieldValidate(this)
                                  : !1);
                    }),
                $('input:visible.number_mask')
                    .filter('.cnpj, .cpf')
                ...
                $('input:visible.alphanum_mask').keyup(function (e) {
                    return maskInput.keyCodes(e.keyCode, [8, 9])
                        ...
                        : (maskInput.keyUpTest(this, /^[a-z0-9]+$/i),
                          maskInput.keyCodeTest.alphanum(e.keyCode)
                              ? void validator.fieldValidate(this)
                              : !1);
                }),
                ...
                $('input:visible.alphanum_plus_mask').keyup(function (e) {
                    return maskInput.keyCodes(e.keyCode, [8, 9])
                        ...
                        : (maskInput.keyUpTest(this, /^[a-z0-9\.\-_]+$/i),
                          maskInput.keyCodeTest.alphanum_plus(e.keyCode)
                              ? void validator.fieldValidate(this)
                              : !1);
                }),
                ...
                $('input:visible.alpha_mask').keyup(function (e) {
                    return maskInput.keyCodes(e.keyCode, [8, 9])
                        ...
                        : (maskInput.keyUpTest(this, /^[a-z]+$/i),
                          maskInput.keyCodeTest.alpha(e.keyCode)
                              ? void validator.fieldValidate(this)
                              : !1);
                }),
                ...
                $('input:visible.alpha_plus_mask').keyup(function (e) {
                    return maskInput.keyCodes(e.keyCode, [8, 9])
                        ...
                        : (maskInput.keyUpTest(this, /^[a-z\.\-_]+$/i),
                          maskInput.keyCodeTest.alpha_plus(e.keyCode)
                              ? void validator.fieldValidate(this)
                              : !1);
                });
        },
        ...
        keyCodeTest: {
            alpha_plus: function (e) {
                return (
                    maskInput.rangeTest(e, 65, 90) ||
                    maskInput.keyCodes(e, [8, 9, 190, 189, 109])
                );
            },
            alpha: function (e) {
                return (
                    maskInput.rangeTest(e, 65, 90) ||
                    maskInput.keyCodes(e, [8, 9])
                );
            },
            alphanum: function (e) {
                return (
                    maskInput.rangeTest(e, 96, 105) ||
                    maskInput.rangeTest(e, 48, 57) ||
                    maskInput.rangeTest(e, 65, 90) ||
                    maskInput.keyCodes(e, [8, 9])
                );
            },
